...
public class CNFTest {
     ...
     * Here is the converted expression tree:
     *
     * AND / \ AND ( ) / \ | AND ( ) OR / \ | / \ ( ) ( ) OR NOT = | | / \ | / \ OR OR NOT LIKE       <           S.B   "orz"
     *       /         \             /       \       |      /      \   /   \
     * >= LIKE >= = < S.A "%%%" 3.3 4.5 / \ / \ / \ / \ 1.1 2.3 S.A "%%%" 1.1 2.3 S.B "orz"
     */
    @Test
     ...
     *                        OR           NOT          =
     *                   /         \        |        /     \
     * >= < = 19.0 20.0 / \ / \ / \ 5.0 6.0 11.0 12.0 15.0 16.0
     */
    @Test
    ...
    public void test5() throws Exception {
        ...
        Expression expected = CCJSqlParserUtil.parseCondExpression("S.A > 3.5 AND S.B < 4 AND NOT S.C LIKE '\"%%\"' " + "AND NOT S.D = {t '12:04:34'}");
        Expression result = CNFConverter.convertToCNF(expr);
        assertEquals(expected.toString(), result.toString());
    }
    ...
    public void testStackOverflowIssue1576_2() throws JSQLParserException {
        Expression expr = CCJSqlParserUtil.parseCondExpression("((3.0 >= 4.0 AND 5.0 <= 6.0) OR " + "(7.0 < 8.0 AND 9.0 > 10.0) OR " + "(11.0 = 11.0 AND 19.0 > 20.0) OR " + "(17.0 = 14.0 AND 19.0 > 17.0) OR " + "(17.0 = 18.0 AND 20.0 > 20.0) OR " + "(17.0 = 16.0 AND 19.0 > 20.0))");
        Expression result = CNFConverter.convertToCNF(expr);
