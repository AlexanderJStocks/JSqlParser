...
public class PostgresTest {
    ...
    public void testJSonExpressionIssue1696() throws JSQLParserException {
        ...
        SelectItem<?> selectExpressionItem = (SelectItem) plainSelect.getSelectItems().get(0);
