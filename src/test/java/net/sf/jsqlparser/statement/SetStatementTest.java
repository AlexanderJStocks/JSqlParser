...
public class SetStatementTest {
    ...
    public void testObject() {
        ...
        setStatement.add("standard_conforming_strings", new ExpressionList(new StringValue("ON")), false);
        setStatement.withUseEqual(0, true).remove(0);
        assertEquals(0, setStatement.getCount());
        setStatement.addKeyValuePairs(new SetStatement.NameExpr("test", new ExpressionList(new StringValue("1")), false));
