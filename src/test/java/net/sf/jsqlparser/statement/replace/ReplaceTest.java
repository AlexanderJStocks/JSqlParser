...
public class ReplaceTest {
    ...
    public void testReplaceSyntax1() throws JSQLParserException {
        ...
        assertEquals(565L, ((LongValue) upsert.getUpdateSets().get(2).getValues().get(0)).getValue());
    }
    ...
    public void testReplaceSyntax2() throws JSQLParserException {
        ...
        ExpressionList expressions = (ExpressionList) ((Values) replace.getSelect()).getExpressions();
    ...
    public void testProblemReplaceParseDeparse() throws JSQLParserException {
        TestUtils.assertSqlCanBeParsedAndDeparsed("REPLACE a_table (ID, A, B) SELECT A_ID, A, B FROM b_table", true);
    }

    @Test
    public void testProblemMissingIntoIssue389() throws JSQLParserException {
        TestUtils.assertSqlCanBeParsedAndDeparsed("REPLACE INTO mytable (key, data) VALUES (1, \"aaa\")", true);
    }

    @Test
    public void testMultipleValues() throws JSQLParserException {
        TestUtils.assertSqlCanBeParsedAndDeparsed("REPLACE INTO mytable (col1, col2, col3) VALUES (1, \"aaa\", now()), (2, \"bbb\", now())", true);
    }
}
